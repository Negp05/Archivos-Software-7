...
<body>
    ...
    if (isset($_SESSION['nombre'])) {
        echo "<p>Nombre guardado: <strong>" .
htmlspecialchars($_SESSION['nombre']) . "</strong></p>";
        echo "<p>Curso: <strong>" . htmlspecialchars($_SESSION['curso'])
. "</strong></p>";
    } else {
    ...
    <form method="POST">
        <input type="submit" name="accion" value="destruir">
    </form>
</body>
</html>
